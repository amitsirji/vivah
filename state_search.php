...
<tr><td >
	...
	<table border=0 width=100% height=0% bgcolor="white" align="center" cellspacing=3% cellpadding=3%>
		<tr>
	...
	<table border=0 width=100% height=0% bgcolor="white" align="center" cellspacing=2% cellpadding=0%>
		<tr>
			<td align="right">
				<table border=0 width=100%  align="center" cellspacing=0% cellpadding=0%>
					<tr>
						<td  colspan=3>
							<hr size=2 width=100% color="darkred"><font face="Baskerville Old Face" size=6> <center>
                  <strong>&nbsp;&nbsp;State Search:</strong>&nbsp;&nbsp;<font face="Baskerville Old Face" size=4 color="darkgreen"><b>To Find Your Life partner from a particular State ...!</font></center>
							<hr size=2 width=100% color="darkred">
						</td>
					</tr>
					<tr>
						<td align="center" colspan=3>
							<a href="state_search.php"><font color="darkgreen">State Search</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<a href="city_search.php">City Search</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<a href="smart_search.php">Smart Search</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<a href="profession_search.php">Profession Search</a>&nbsp;&nbsp;&nbsp;
						</td>
					</tr>
					<tr>	
						<td width=50% align="left" valign="top" height=100%>
								<form name="ff1" method="POST" action="searchinformation1.php">
							<br>&nbsp;&nbsp;<b><font face="Baskerville Old Face" size=4><img src="pictures/bull.gif"></img>&nbsp;Basic Information:<br>&nbsp;&nbsp;&nbsp;-------------------------</font></b><br>
							<font id="b"><br>
							<!-- <form name="ff1" action="searchinformation1.php" method="POST"> -->
				...
				<select name="age2">
					<script language="javascript">
						for(k=18;k<=60;k++)
							...
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;State:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<select name="state">
									...
									<input type="hidden" name="hdn" value="state_search">	
						...
						<td background="pictures/desg3.jpg" width=100% colspan=2 height=100%>
