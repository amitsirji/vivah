	...
	<table border=0 width=100% height=100% align="center" cellspacing=0% cellpadding=0%>	
		<form name="idpass" method="POST" action="searchinformation2.php">
			<td colspan=3 bgcolor="#FFCCCC" align="right">
				...
				&nbsp;&nbsp;&nbsp;<input type="submit" name="idsubmit" value="Search">&nbsp;&nbsp;&nbsp;&nbsp;<input type="hidden" value="profession_search" name="pg">
			</td>
			</form>
		<tr>
		...
		<tr>
			<td align="right">
				<table border=0 width=75%  align="center" cellspacing=0% cellpadding=0%>
                  ...
                  <font face="Baskerville Old Face" size=6><center> <strong>&nbsp;&nbsp;Profession 
                  Search:</strong></font>&nbsp;&nbsp;<font face="Baskerville Old Face" size=4 color="darkgreen"><b>To 
                  Find Your Life partner By Searching particular profession</font></center>
                  <hr size=2 width=100% color="darkred">
						</td>
					</tr>
					<tr>
						<td align="center" colspan=3>
							...
							<a href="profession_search.php"><font color="darkgreen">Profession Search</font></a>&nbsp;&nbsp;&nbsp;
						</td>
					</tr>
					<tr>	
						<td width=60% align="left" valign="top" height=100%>
							<form name="ff4" action="searchinformation1.php" method="POST">
					...
					<script language="javascript">
						for(k=18;k<=60;k++)
							document.write("<option>" + k + "</option>")
								...
								<input type="hidden" name="hdn" value="profession_search">
...
<body VLINK="0000AA" ALINK="red" onunload="chgmncolor()">
</body>
</html>