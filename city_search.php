...
<tr><td >
	...
	<table border=0 width=100% height=100%  bgcolor="#FFFFFF" align="center" cellspacing=2% cellpadding=0%>
		<tr>
			<td align="right">
				<table border=0 width=100%  align="center" cellspacing=0% cellpadding=0%>
					<tr>
						<td colspan=3>
							...
							<font face="Baskerville Old Face" size=6>
								<center><strong>&nbsp;&nbsp;City Search:</strong></font>&nbsp;&nbsp;<font face="Baskerville Old Face" size=4 color="darkgreen"><b>To Find Your Life partner By Searching from a particular city...!</font></center>
							<hr size=2 width=100% color="darkred">
						</td>
					</tr>
					<tr>
						<td align="center" colspan=3>
							...
							<a href="city_search.php"><font color="darkgreen">City Search</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<tr>	
						<td width=60% align="left" valign="top" height=100%>
							<form name="ff2" method="POST" action="searchinformation1.php">
					...
					<script language="javascript">
						for(k=18;k<=60;k++)
							document.write("<option>" + k + "</option>")
								...
								<input type="hidden" name="hdn" value="city_search">	
